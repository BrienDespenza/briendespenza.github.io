var init = function (window) {
    ...
    var background = opspark.makeBackground(app,ground); // created a variable called background which it stores the bg in
    view.addChild(background); // adds the bg to the canvas so we can see it
